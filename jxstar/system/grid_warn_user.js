Jxstar.currentPage = function() {
	...
	{col:{header:'上报ID', width:100, sortable:true, hidden:true}, field:{name:'warn_user__warn_id',type:'string'}},
	{col:{header:'分配ID', width:100, sortable:true, hidden:true}, field:{name:'warn_user__user_detid',type:'string'}},
	{col:{header:'用户ID', width:100, sortable:true, hidden:true}, field:{name:'warn_user__user_id',type:'string'}},
	{col:{header:'分配条件', width:238, sortable:true, editable:true, hcss:'color:#3039b4;',
