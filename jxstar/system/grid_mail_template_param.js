Jxstar.currentPage = function() {
	...
	{col:{header:'参数代号', width:172, sortable:true, editable:true, hcss:'color:#3039b4;',
		editor:new Ext.form.TextField({
			maxLength:30
		})}, field:{name:'mail_template_param__param_name',type:'string'}},
	{col:{header:'参数标题', width:141, sortable:true, editable:true, hcss:'color:#3039b4;',
		editor:new Ext.form.TextField({
			maxLength:50
	...
	{col:{header:'缺省值', width:389, sortable:true, editable:true, hcss:'color:#3039b4;',
		editor:new Ext.form.TextField({
			maxLength:100
