		...
		items:[{
			...
			items:[{
				...
				items:[
					...
					{xtype:'datefield', fieldLabel:'代理开始日期', name:'sys_proxy__start_date', format:'Y-m-d', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', anchor:'100%'},
				...
				items:[
					...
					{xtype:'datefield', fieldLabel:'代理结束日期', name:'sys_proxy__end_date', format:'Y-m-d', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', anchor:'100%'},
			...
			items:[{
				...
				style: 'padding-left:10px;',
				items:[
					{xtype:'textarea', fieldLabel:'设置说明', name:'sys_proxy__set_memo', width:'100%', height:72, maxLength:200}
				]
			}
			]
		}]
