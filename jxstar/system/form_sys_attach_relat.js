	...
	var items = [{
		...
		items:[{
			...
			items:[{
				...
				items:[
					{xtype:'textfield', fieldLabel:'当前表名', name:'sys_attach_relat__table_name', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', anchor:'100%', maxLength:50},
				...
				style: 'padding-left:10px;',
				items:[
					{xtype:'textfield', fieldLabel:'关联表名', name:'sys_attach_relat__target_table', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', anchor:'100%', maxLength:50},
			...
			items:[{
				...
				style: 'padding-left:10px;',
				items:[
					{xtype:'textarea', fieldLabel:'关联SQL或类名', name:'sys_attach_relat__relat_sql', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', width:'100%', height:96, maxLength:200}
				]
			}
			]
		}]
