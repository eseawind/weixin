	...
	var items = [{
		...
		items:[{
			...
			items:[{
				...
				style: 'padding-left:10px;',
				items:[
					{xtype:'textarea', fieldLabel:'问题描述', name:'sys_question__que_desc', readOnly:true, width:'100%', height:72, maxLength:200}
				]
			}
			]
		}]
			...
			items:[{
				...
				style: 'padding-left:10px;',
				items:[
					{xtype:'textarea', fieldLabel:'原因分析及处理结果', name:'sys_question__done_desc', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', width:'100%', height:72, maxLength:200}
				]
			}
			]
		}]
