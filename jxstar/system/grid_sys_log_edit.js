Jxstar.currentPage = function() {
	...
	{col:{header:'用户ID', width:100, sortable:true, hidden:true}, field:{name:'sys_log_edit__user_id',type:'string'}},
	{col:{header:'主键', width:100, sortable:true, hidden:true}, field:{name:'sys_log_edit__edit_id',type:'string'}}
	];
