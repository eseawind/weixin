Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'名称', width:137, sortable:true}, field:{name:'sys_news_obj__obj_name',type:'string'}},
	{col:{header:'编号', width:96, sortable:true, hidden:true}, field:{name:'sys_news_obj__obj_code',type:'string'}},
	{col:{header:'类型', width:66, sortable:true, align:'center',
		editable:false,
