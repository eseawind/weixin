Jxstar.currentPage = function() {
	...
	{col:{header:'登录时间', width:142, sortable:true, renderer:function(value) {
			return value ? value.format('Y-m-d H:i:s') : '';
		}}, field:{name:'sys_user_login__login_date',type:'date'}},
	{col:{header:'用户ID', width:100, sortable:true, hidden:true}, field:{name:'sys_user_login__user_id',type:'string'}},
	{col:{header:'日志ID', width:100, sortable:true, hidden:true}, field:{name:'sys_user_login__log_id',type:'string'}},
	{col:{header:'主键', width:100, sortable:true, hidden:true}, field:{name:'sys_user_login__login_id',type:'string'}},
	{col:{header:'部门名称', width:119, sortable:true}, field:{name:'sys_user_login__dept_name',type:'string'}},
	{col:{header:'部门ID', width:100, sortable:true, hidden:true}, field:{name:'sys_user_login__dept_id',type:'string'}},
	{col:{header:'客户端程序', width:334, sortable:true}, field:{name:'sys_user_login__client_agent',type:'string'}},
	{col:{header:'会话ID', width:100, sortable:true, hidden:true}, field:{name:'sys_user_login__session_id',type:'string'}}
	];
