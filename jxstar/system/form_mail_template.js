	...
	var items = [{
		...
		items:[{
			...
			items:[{
				...
				items:[
					{xtype:'textfield', fieldLabel:'模板标识', name:'mail_template__template_tag', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', anchor:'100%', maxLength:30},
			...
			items:[{
				...
				style: 'padding-left:10px;',
				items:[
					{xtype:'textarea', fieldLabel:'模板内容', name:'mail_template__template_cont', width:'100%', height:216, maxLength:0}
				]
			}
			]
		}]
