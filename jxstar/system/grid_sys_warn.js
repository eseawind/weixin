Jxstar.currentPage = function() {
	...
	{col:{header:'功能名称', width:120, sortable:true}, field:{name:'warn_base__fun_name',type:'string'}},
	{col:{header:'上报消息描述', width:319, sortable:true}, field:{name:'warn_base__warn_desc',type:'string'}},
	{col:{header:'触发事件代码', width:100, sortable:true, hidden:true}, field:{name:'warn_base__event_code',type:'string'}},
	{col:{header:'上报条件SQL', width:100, sortable:true, hidden:true}, field:{name:'warn_base__where_sql',type:'string'}},
	{col:{header:'判断间隔时间值', width:100, sortable:true, hidden:true}, field:{name:'warn_base__time_value',type:'string'}},
	{col:{header:'执行间隔时间值', width:100, sortable:true}, field:{name:'warn_base__run_plan',type:'string'}},
	...
	{col:{header:'上次运行时间', width:138, sortable:true, align:'center',
