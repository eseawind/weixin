Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'*数据名称', width:127, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:20, allowBlank:false
		})}, field:{name:'sys_datatype__dtype_name',type:'string'}},
	{col:{header:'*权限字段', width:112, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:20, allowBlank:false
		})}, field:{name:'sys_datatype__dtype_field',type:'string'}},
	{col:{header:'*来源功能', width:107, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:25, allowBlank:false
		})}, field:{name:'sys_datatype__funid',type:'string'}},
	{col:{header:'*来源字段', width:181, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
		})}, field:{name:'sys_datatype__fun_field',type:'string'}},
	{col:{header:'*显示字段', width:186, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
		})}, field:{name:'sys_datatype__fun_vfield',type:'string'}},
	{col:{header:'设置ID', width:100, sortable:true, hidden:true}, field:{name:'sys_datatype__dtype_id',type:'string'}},
	{col:{header:'控件代码', width:100, sortable:true, editable:true, hcss:'color:#3039b4;',
		editor:new Ext.form.TextField({
			maxLength:20
