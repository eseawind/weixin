Jxstar.currentPage = function() {
	...
	{col:{header:'开始时间', width:119, sortable:true, renderer:function(value) {
			return value ? value.format('Y-m-d H:i:s') : '';
		}}, field:{name:'wf_task__start_date',type:'date'}},
	{col:{header:'受限时间', width:100, sortable:true, renderer:function(value) {
			return value ? value.format('Y-m-d') : '';
		}}, field:{name:'wf_task__limit_date',type:'date'}},
	{col:{header:'功能名称', width:149, sortable:true, hidden:true}, field:{name:'wf_process__fun_name',type:'string'}},
	...
	{col:{header:'过程实例ID', width:100, sortable:true, hidden:true}, field:{name:'wf_task__instance_id',type:'string'}},
	{col:{header:'主键', width:100, sortable:true, hidden:true}, field:{name:'wf_task__task_id',type:'string'}},
	{col:{header:'过程ID', width:100, sortable:true, hidden:true}, field:{name:'wf_task__process_id',type:'string'}},
	{col:{header:'模块ID', width:100, sortable:true, hidden:true}, field:{name:'wf_process__module_id',type:'string'}},
	{col:{header:'节点ID', width:100, sortable:true, hidden:true}, field:{name:'wf_task__node_id',type:'string'}}
	];
