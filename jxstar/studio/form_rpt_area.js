		...
		items:[{
			...
			items:[{
				...
				items:[
					...
					{xtype:'numberfield', decimalPrecision:0, fieldLabel:'每页行数', name:'rpt_area__page_size', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', anchor:'100%', maxLength:22},
