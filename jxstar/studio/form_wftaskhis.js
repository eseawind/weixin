	...
	var items = [{
		...
		items:[{
			...
			items:[{
				...
				style: 'padding-left:10px;',
				items:[
					{xtype:'datefield', fieldLabel:'处理时间', name:'wf_assignhis__check_date', format:'Y-m-d H:i', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', anchor:'100%'},
					{xtype:'datefield', fieldLabel:'受限时间', name:'wf_taskhis__limit_date', format:'Y-m-d H:i', anchor:'100%', readOnly:true},
					{xtype:'textfield', fieldLabel:'节点名称', name:'wf_taskhis__node_title', readOnly:true, anchor:'100%', maxLength:1000},
			...
			items:[{
				...
				style: 'padding-left:10px;',
				items:[
					{xtype:'textarea', fieldLabel:'处理意见', name:'wf_assignhis__check_desc', allowBlank:false, labelStyle:'color:#0000FF;', labelSeparator:'*', width:'100%', height:120, maxLength:500}
				]
			}
			]
		}]
