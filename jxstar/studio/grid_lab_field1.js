Jxstar.currentPage = function() {
	...
	{col:{header:'字段名称', width:130, sortable:true}, field:{name:'lab_field__field_title',type:'string'}},
	{col:{header:'字段', width:112, sortable:true, hidden:true}, field:{name:'lab_field__field_code',type:'string'}},
