Jxstar.currentPage = function() {
	...
	{col:{header:'流程图编号', width:127, sortable:true, editable:true, hcss:'color:#3039b4;',
		editor:new Ext.form.TextField({
			maxLength:20
		})}, field:{name:'wfnav_graph__graph_code',type:'string'}},
	{col:{header:'*流程图名称', width:227, sortable:true, editable:true, hcss:'color:#0000ff;',
		editor:new Ext.form.TextField({
			maxLength:100, allowBlank:false
		})}, field:{name:'wfnav_graph__graph_name',type:'string'}},
	{col:{header:'模块名称', width:133, sortable:true, editable:true, hcss:'color:#3039b4;',
	...
	{col:{header:'主键', width:100, sortable:true, hidden:true}, field:{name:'wfnav_graph__graph_id',type:'string'}},
	{col:{header:'模块ID', width:100, sortable:true, hidden:true}, field:{name:'wfnav_graph__module_id',type:'string'}}
	];
