Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'功能ID', width:157, sortable:true, hidden:true}, field:{name:'sys_coderule__fun_id',type:'string'}},
	...
	{col:{header:'编码规则ID', width:100, sortable:true, hidden:true}, field:{name:'sys_coderule__rule_id',type:'string'}}
	];
