Jxstar.currentPage = function() {
	...
	{col:{header:'节点ID', width:100, sortable:true, hidden:true}, field:{name:'wf_node__node_id',type:'string'}},
	{col:{header:'功能ID', width:100, sortable:true, hidden:true}, field:{name:'wf_process__fun_id',type:'string'}},
	{col:{header:'属性ID', width:100, sortable:true, hidden:true}, field:{name:'wf_nodeattr__nodeattr_id',type:'string'}}
	];
