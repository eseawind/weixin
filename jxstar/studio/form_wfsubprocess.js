				...
				items:[
					{xtype:'trigger', fieldLabel:'子过程', name:'wf_subprocess__sub_process',
						...
						onTriggerClick: function() {
							var selcfg = {pageType:'combogrid', nodeId:'wf_process', layoutPage:'', sourceField:'wf_process.process_name;process_id', targetField:'wf_subprocess.sub_process;sub_processid', whereSql:"process_state < '3' and process_id <> ?", whereValue:'[wf_subprocess.process_id]', whereType:'string', isSame:'0', isShowData:'1', isMoreSelect:'0',isReadonly:'1',fieldName:'wf_subprocess.sub_process'};
