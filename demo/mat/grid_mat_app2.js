Jxstar.currentPage = function() {
	...
	{col:{header:'申请单号', width:131, sortable:true}, field:{name:'mat_app__app_code',type:'string'}},
	...
	{col:{header:'项目名称', width:147, sortable:true}, field:{name:'mat_app__project_name',type:'string'}},
	{col:{header:'申请理由', width:281, sortable:true, hidden:true}, field:{name:'mat_app__app_cause',type:'string'}},
	...
	{col:{header:'反馈日期', width:100, sortable:true, align:'center',
		renderer:function(value) {
			return value ? value.format('Y-m-d') : '';
		}}, field:{name:'mat_app__result_date',type:'date'}},
	{col:{header:'反馈人', width:73, sortable:true}, field:{name:'mat_app__result_user',type:'string'}},
	{col:{header:'反馈结果', width:210, sortable:true}, field:{name:'mat_app__result_memo',type:'string'}}
	];
