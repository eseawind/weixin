...
public class PortalQuery extends BusinessObject {
	 ...
	 * @return
	 */
	public List<Map<String,String>> queryPortlet(String templetId) {
	 ...
	 * @return
	 */
	public List<Map<String,String>> queryTemplet(String userId) {
		StringBuilder sql = new StringBuilder();
	 ...
	 * @return
	 */
	public Map<String,String> queryOneTemplet(String templetId) {
		StringBuilder sql = new StringBuilder();
		sql.append("select templet_no, templet_name, col_num, col_width, templet_id ");
		sql.append("from plet_templet where templet_id = ?");
