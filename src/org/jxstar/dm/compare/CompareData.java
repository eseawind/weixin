...
public class CompareData {
    ...
    public String insertSql(List<Map<String,String>> lsField, Map<String,String> srcData, 
        ...
        String keyField=DmDaoUtil.getKeyField(targetTable);
        String keyValue=KeyCreator.getInstance().createKey(targetTable);
    	//构建新增一条记录的SQL
    	StringBuilder sbinsert = new StringBuilder();
    	if(allfield.contains(keyField)){
    		sbinsert.append("insert into " + targetTable + " (");
    		sbinsert.append(allfield + ")\r\n "+ "values(" +keyValue+","+ allvalue + ");\r\n\r\n");
    	}else{
    		sbinsert.append("insert into " + targetTable + " ("+keyField+",");
    		sbinsert.append(allfield + ")\r\n "+ "values('" +keyValue+"',"+ allvalue + ");\r\n\r\n");
    	}
